...
class GameOver(UIWindow):
	def __init__(self,
		...
		super().__init__(rect, ui_manager, window_display_title='Game Over', resizable=False, draggable=False, always_on_top=True)
		...
		self.background_image = UIImage(relative_rect=pygame.rect.Rect(0, 0, self.relative_rect.width, self.relative_rect.height),
